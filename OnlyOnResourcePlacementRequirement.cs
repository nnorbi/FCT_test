public class OnlyOnResourcePlacementRequirement : IPlacementRequirement
{
	public bool Check(BuildingDescriptor descriptor)
	{
		...
		for (int i = 0; i < tiles.Length; i++)
		{
			...
			if (!descriptor.Island.IsValidAndFilledTile_I(in containedTile_I) || descriptor.Island.GetTileInfo_UNSAFE_I(in containedTile_I).BeltResource == null)
			{
				return false;
			}
		}
