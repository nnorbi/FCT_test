...
public class Lift1DownBackwardEntity : Lift1LayerEntity
{
	protected static VariantConfig Config = new VariantConfig
	{
		...
		Paddle1_Pos_L = new float3(0f, -0.41f, 0f),
		Paddle1_BaseRotation = 0f,
		Paddle1_AngleScale = -30f,
		Paddle1_Length = 0.41f,
		RotateShapeWithPaddle = true,
		EqualAnimations = true,
		InvertAnimations = true
	};

	public Lift1DownBackwardEntity(CtorArgs payload)
		: base(payload)
	{
	}
